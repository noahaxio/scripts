...
TARGET_DIR="$REAL_HOME/Renderers"
REPO_URL="https://github.com/noahaxio/renderers"
...
# (This ensures the .git folder and files belong to the user, not root)
chown -R "$REAL_USER":"$REAL_USER" "$TARGET_DIR"

echo "Done. Renderers directory is up to date and executable."